...
$base_path = "";
$base_path = Yii::getAlias('@webroot').'/frontend/modules/referral/error';
if(!is_dir($base_path))
{
...
$newUrl=Yii::$app->getUrlManager()->getBaseUrl().'/frontend/modules/referral/error/'.$filename;
?>
<?php $view->beginPage() ?>
...
<head>
	...
	<link rel="stylesheet" href="<?= Yii::$app->getUrlManager()->getBaseUrl();?>/frontend/modules/referral/assets/css/font-awesome.min.css">
	...
	<script type="text/javascript">
		...
		<link rel="stylesheet" href="<?= Yii::$app->getUrlManager()->getBaseUrl();?>/frontend/modules/referral/assets/css/bootstrap.css">
		<link rel="stylesheet" href="<?= Yii::$app->getUrlManager()->getBaseUrl();?>/frontend/modules/referral/assets/css/style.css">
