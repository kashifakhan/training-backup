...
use frontend\modules\walmart\components\ShopifyApiException;
use Exception;
...
class ShopifyClientHelper extends Component
{
    ...
    {
        $path = 'shopify-exception.log';
        $message = '';
        if ($url == 'https') {

            $message .= $method . PHP_EOL;
            Data::createLog($message, $path);
            return;
        }
