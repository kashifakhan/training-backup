...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/swatchimage/'.Yii::$app->user->identity->username.'/temp/',
            'upload_url' => $this->get_full_url().'/swatchimage/'.Yii::$app->user->identity->username.'/temp/',
...
//'max_height' => 80
    ...
    protected function set_additional_file_properties($file) {
        $file->deleteUrl = $this->options['script_url'].'/walmart/fileupload/'
            .$this->get_query_separator($this->options['script_url'])
            .$this->get_singular_param_name()
            .'='.rawurlencode($file->name);
        //var_dump($file->deleteUrl);die;
