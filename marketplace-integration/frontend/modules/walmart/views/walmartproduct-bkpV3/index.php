    ...
    <div class="form new-section">
        ...
        <div class="jet-pages-heading walmart-title">
            ...
            <div class="product-upload-menu confirmbox">
                ...
                <?= Html::a('Update Price', ['updateprice'], ['data-toggle' => 'tooltip', 'title' => 'Sync product(s) price on walmart.', 'data-step' => '8', 'data-position' => 'top', 'data-intro' => 'Sync product(s) price on walmart.', 'class' => 'btn btn-primary']) ?>
                ...
                <div class="popup-box confirmbox">
                    ...
                    <?= Html::a('Get Product Status', ['batchproductstatus'], ['data-toggle' => 'tooltip', 'title' => 'Get product(s) status from walmart.','data-step' => '11', 'data-position' => 'top', 'data-intro' => 'Get product(s) status from walmart.', 'class' => 'btn btn-primary']) ?>
                    ...
                    <?= Html::a('Get Promo Price Status', ['getpromostatus'], ['data-toggle' => 'tooltip', 'title' => 'Get product(s) promo price status from walmart.', 'data-step' => '13', 'data-position' => 'top', 'data-intro' => 'Get product(s) promo price status from walmart.', 'class' => 'btn btn-primary']) ?>
        ...
        <?= GridView::widget([
            ...
            'columns' => [
               ...
               /* [
                    ...
                    'label'=>'Updated At',
                    'value'=>'jet_product.updated_at',
                    'format'=>'raw',
                    'filter' => 'From : <input id="updated_at" class="form-control" type="text" name="' . $searchModel->getClassName() . '[updated_at]" value="' . $searchModel->updated_at . '" /><br/>' . 'To : <input class="form-control" type="text" name="' . $searchModel->getClassName() . '[updated_at2]" value="' . $searchModel->updated_at2 . '"/>',
