...
$ipmort_url=\yii\helpers\Url::toRoute(['productcsv/index']);
$url=\yii\helpers\Url::toRoute(['productcsv/export']);
$productUrl= \yii\helpers\Url::toRoute(['productcsv/index']);
$productfeedUrl= \yii\helpers\Url::toRoute(['productcsv/exportproduct?status='.$action]);
        ...
        <div class="panel panel-default form new-section">
            <div class="jet-pages-heading">
                <div class="title-need-help">
                    <h1 class="Jet_Products_style">Exporting Products</h1>
                </div>
            ...
            <div class="block-content panel-body shopify-api ">
                <ul class="warning-div" style="margin-top: 18px">
                    ...
                    <li class="status_warning">
                        ...
                        Warning: Please do not close the window during export data
                    </li>
                </ul>
...
//                    update_row.parentNode.insertBefore(span, update_row);
                ...
                if(id < pages){
                    ...
                    span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span id="update_status" class="text">'+countOfSuccess+' Product Successfully Exported.'+'</span>';
            ...
            error: function(){
                ...
                if(id < pages){
                    ...
                    status_image.src = '<?php echo $succes_img ?>';
                    var span = document.createElement('li');
                    span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span id="update_status" class="text">'+countOfSuccess+' Product(s) Exported .'+'</span>';
                    span.style = 'background-color:#DDF';
                    my_id.parentNode.insertBefore(span, my_id);
                    //$('liFinished').show();
                    j$(".warning-div").hide();
