        ...
        j$.ajax({
            ...
            success: function(json) {
                ...
                if(json.success) {
                    ...
                    span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span class="text">'+json.count+' Product(s) price feed successfully submitted on walmart of page '+id+'.</span>';
