                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                                ...
                                                <div class="public">
                                                    <input class="form-control walmart-title" type="text"
                                                           ...
                                                           value="<?php if (isset($walmartproduct['product_title']) && !empty($walmartproduct['product_title'])) {
                                                               echo htmlspecialchars($walmartproduct['product_title']);
                                                           } else {
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <textarea name="long_description" id="product_desc"
                                ...
                                <div class="table-responsive grid-view">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="public">
                                                    <input type="text" name="JetProduct[product_tax]"
                                                           value="<?= $tax_code; ?>"
                                                        ...
                                                        <div class="pull-left">
                                                            <div class="public">
                                                                <input class="form-control walmart-inventory"
                                                                       ...
                                                                       name="walmart_product_inventory"
                                                                       value="<?php
                                                ...
                                                <tr>
                                                    <td>
                                                        <select default-value="<?= $isShippingAllowed ?>"
                                                                ...
                                                                name="exceptions[isShippingAllowed][]">
...
<script type="text/javascript">
    ...
    function walmartInventorymodal() {
        $('body').attr('data-cnfrminventory', 'show');
        $('#edit-modal-close').click();
        $("#edit_walmart_product #myModal").on('hidden.bs.modal', function () {
            if ($('body').attr('data-cnfrminventory') == 'show') {
                $('#confirm-inventory').modal('show');
                $('body').removeAttr('data-cnfrminventory');
            }
        });
