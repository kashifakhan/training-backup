<?php
yii\web\View::registerJsFile(Yii::$app->request->baseUrl.'/js/jquery-customselect-1.9.1.min.js',['depends' => [\yii\web\JqueryAsset::className()]]);
yii\web\View::registerCssFile("/css/jquery-customselect-1.9.1.css");
yii\web\View::registerJs('$(function() {$("#standard").customselect();});');
?>
<style type="text/css">
  .custom-select {
  position: relative;
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" style="text-align: center;font-family: "Comic Sans MS";">Product Tax</h4>
        </div>
        <div class="modal-body">
          <div class="custom-select">
            <a href="#">
              <span>None - Please Select</span>
            </a>
            <select id='standard' name='tax_code' class='custom-select'>
              ...
              if(is_array($taxCollection) && count($taxCollection)>0)
              {
                ...
                { ?>
                  <option value="<?= $value['tax_code']?>"><?= strlen($value['cat_desc']) > 50 ? substr($value['cat_desc'],0,50)."..." : $value['cat_desc']?>
                  </option>;
                <?php
                }
              }?>
