...
//                    console.log(json.success);
                ...
                if (id < pages) {
                    ...
                    var span = document.createElement('li');
                    if (notSku && notSku > 0) {
                        span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span id="update_status" class="text">' + countOfSuccess + ' Product(s) Successfully Synced and ' + notSku + ' products unable to sync due to missing product sku(s).' + '</span>';
                    } else {
