...
use yii\helpers\Html;
	...
	$url = \frontend\modules\walmart\components\Data::getUrl('walmartproductdetail/updateinventory');
	$backUrl = \frontend\modules\walmart\components\Data::getUrl('walmartproductdetail/index');
?>
<style type="text/css" >
        ...
        <div class="panel panel-default form new-section">
         ...
         <div class="block-content panel-body shopify-api ">         
               ...
               <li style="background-color:#Fff;">
                  ...
                  Starting Product Inventory updation, please wait...
               </li>
               <li style="background-color:#FFD;">
                  ...
                  Warning: Please do not close the window during inventory updation process
               </li>
            </ul>
            ...
            <ul id="profileRows">
               <li style="background-color:#DDF; ">
                  ...
                  <?php echo 'Total '.$totalcount.' Product(s) are Selected for inventory update.'; ?>
               </li>
               ...
               <li id="liFinished" style="display:none;background-color:#Fff;">
                  <img src="<?php echo yii::$app->request->baseUrl.'/frontend/images/batchupload/note_msg_icon.gif';?>" class="v-middle" style="margin-right:5px"/>
                  Finished Product inventory updation process.
               </li>
            </ul>
            </div>
        </div>     
      ...
      j$.ajax({
         ...
         success: function(json) {
            ...
            if(json.success) {
               ...
               span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span class="text">'+json.success_msg+'</span>';
               span.id = 'id-'+id;
            ...
            if(id < pages) {
               ...
               var span = document.createElement('li');
               span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span id="update_status" class="text">'+countOfSuccess+' Product(s) Inventory Feed Successfully Submitted to Walmart.'+'</span>';
               span.style = 'background-color:#DDF';
