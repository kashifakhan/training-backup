...
<div class="site-register">
    <div class="content-section">
        <div class="">
            ...
            <?= $form->field($model, 'time_zone', ['options' => []])->dropDownList($timeZoneOptions, ['prompt' => 'Choose...']) ?>
            <?= $form->field($model, 'time_slot', ['options' => []])->dropDownList($timeslot, ['prompt' => 'Choose...']) ?>
            <?= $form->field($model, 'time_format', ['options' => []])->dropDownList($time_format, ['prompt' => 'Choose...']) ?>
