...
$url=\yii\helpers\Url::toRoute(['updatecsv/retireprod']);
$productUrl= \yii\helpers\Url::toRoute(['updatecsv/index']);
$productfeedUrl= \yii\helpers\Url::toRoute(['updatecsv/exportretireproduct?status='.$status]);
        ...
        <div class="panel panel-default form new-section">
            <div class="jet-pages-heading">
                <div class="title-need-help">
                    <h1 class="Jet_Products_style">Exporting Product</h1>
                </div>
            ...
            <div class="block-content panel-body shopify-api ">
                <ul class="warning-div" style="margin-top: 18px">
                    <li class="status_finish">
                        ...
                        Starting Product exporting status execution, please wait...
                    </li>
                ...
                <ul id="profileRows">
                    ...
                    <li id="liFinished" class="status_finish" style="display:none;">
                        <img src="<?php echo yii::$app->request->baseUrl.'/frontend/images/batchupload/note_msg_icon.gif';?>" class="v-middle" style="margin-right:5px"/>
                        Finished product exporting execution.
                    </li>
                </ul>
            </div>
        </div>
        ...
        j$.ajax({
            ...
            success: function(json) {//transport
                ...
                if(json.success){
                    ...
                    span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span class="text">'+json.count+' Product Exporting of page '+id+'...</span>';
                    span.id = 'id-'+id;
...
//                    update_row.parentNode.insertBefore(span, update_row);
                ...
                if(id < pages){
                    ...
                    span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span id="update_status" class="text">'+countOfSuccess+' Successfully Product Exported.'+'</span>';
