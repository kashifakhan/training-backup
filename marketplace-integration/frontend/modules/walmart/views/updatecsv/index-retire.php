        ...
        <div class="csv_import col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="csv_import1">
                <form action="<?php echo \yii\helpers\Url::toRoute(['updatecsv/exportretireproduct']);?>" method="post">
                    ...
                    <p>If you don't want any product on Walmart then retire them from here. Just selct the status of product and click on Export. You will get a csv in which you can perform changes.
                    </p>
        ...
        <div class="csv_export col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="csv_import1">
                <form action="<?php echo $importUrl;?>" method="post" enctype="multipart/form-data">
                    ...
                    <p>Browse the updated file here and click on Import. You will be able to retire your products from Walmart.</p>
    ...
    $(function () {
        ...
        var intro = introJs().setOptions({
            ...
            steps: [
                ...
                {
                    element: '#action-dropdown1',
                    intro: 'Select product status of which .',
                    position: 'left'
                },
                {
                    element: '#export',
        ...
        $(document).ready(function () {
            ...
            setTimeout(function () {
                productQuicktour.start().oncomplete(function () {
                    window.location.href = '<?= \frontend\modules\walmart\components\Data::getUrl("walmartconfiguration/index?tour") ?>';
                }, 1000);
            });
        });
    </script>
