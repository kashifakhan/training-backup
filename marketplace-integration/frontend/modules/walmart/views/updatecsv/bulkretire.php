...
$url=\yii\helpers\Url::toRoute(['updatecsv/retireproduct']);
$productfeedUrl= \yii\helpers\Url::toRoute(['updatecsv/index-retire']);
?>
<style type="text/css" >
            ...
            success: function(json) {//transport
                ...
                if(json.error){
                    ...
                    j$.each(errors,function (index,value) {
                        var span = document.createElement('li');
                        span.innerHTML = '<img class="v-middle" src="<?php echo $error_img ?>"><span class="text">'+value+' : Product Retire failed</span>';
                        span.id = 'id-'+id;
