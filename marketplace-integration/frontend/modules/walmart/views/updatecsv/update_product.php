...
$success_img = Yii::$app->request->baseUrl . '/frontend/images/batchupload/fam_bullet_success.gif';
...
$url = Data::getUrl('updatecsv/update-product');
?>
<style type="text/css">
    .shopify-api ul {
        ...
        <div class="panel panel-default form new-section">
            <div class="jet-pages-heading">
                <div class="title-need-help">
                    <h1 class="Jet_Products_style">Update Product Via CSV</h1>
                </div>
...
//                    console.log(json.success);
                    ...
                    span.innerHTML = '<img class="v-middle" src="<?php echo $success_img ?>"><span class="text">' + json.success.count + ' Product Updated of page ' + id + '...</span>';
                    span.id = 'id-' + id;
