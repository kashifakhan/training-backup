...
?>
							...
							<div class="fieldset enable_api" id="api-section">
										...
										<li>
											<span>Shopify Product Type</span>
										</li>
										<li>
											<span>Type</span>
										</li>
												...
												<div>
												    ...
												    <?php 
												    	...
												    	<div>
												    		...
												    		<ul>
												    			<li>
												    				<?php  $boxwinner = ($variant['buybox']==0) ? 'NO' : 'YES';
										   					echo $boxwinner; ?>
												    			</li>
												    			<li>
												    				<?= $bestvalue['buybox_item_price'] ?>
												    			</li>
												    			<li>
												    				<?= $bestvalue['buybox_item_price'] ?>
												    			</li>
												    			<li>
												    				<?= $bestvalue['buybox_ship_price'] ?>
												    			</li>
												    	...
												    	<div>
												    		<ul>
												    			...
												    			<li>
												    				2nd Best Offer Price :
												    			</li>
												    			<li>
												    				2nd Best Offer Ship Price :
												    			</li>
												    		</ul>
												    		<ul>
												    			
												    			<li>
												    				<?= $best_price_json[1]['offer2_item_price'] ?>
												    			</li>
												    			<li>
												    				<?= $best_price_json[1]['offer2_ship_price'] ?>
												    			</li>
												    	...
												    	<div>
												    		<ul>
												    			...
												    			<li>
												    				3rd Best Offer Price :
												    			</li>
												    			<li>
												    				3rd Best Offer Ship Price :
												    			</li>
												    		</ul>
												    		<ul>
												    			
												    			<li>
												    				<?= $best_price_json[2]['offer3_item_price'] ?>
												    			</li>
												    			<li>
												    				<?= $best_price_json[2]['offer3_ship_price'] ?>
												    			</li>
												    	...
												    	<div>
												    		<ul>
												    			...
												    			<li>
												    				4th Best Offer Price :
												    			</li>
												    			<li>
												    				4th Best Offer Ship Price :
												    			</li>
												    		</ul>
												    		<ul>
												    			
												    			<li>
												    				<?= $best_price_json[3]['offer4_item_price'] ?>
												    			</li>
												    			<li>
												    				<?= $best_price_json[3]['offer4_ship_price'] ?>
												    			</li>
