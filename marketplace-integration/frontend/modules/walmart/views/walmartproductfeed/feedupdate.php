...
$ipmort_url=Yii::$app->request->baseUrl.'/walmart/walmartproductfeed/index';

$url=\yii\helpers\Url::toRoute(['walmartproductfeed/updatefeedstatus']);
$productfeedUrl= \yii\helpers\Url::toRoute(['walmartproductfeed/index']);
