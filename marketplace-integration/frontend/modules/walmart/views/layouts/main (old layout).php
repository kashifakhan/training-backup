...
<head>
 ...
 <?php if(Yii::$app->controller->action->id=='pricing'){
    ...
    <?php 	NavBar::begin([
	        ...
	        $menuItems = [['label' => 'Home', 'url' => ['/walmart-marketplace']]];

			if (Yii::$app->user->isGuest) {
	        	$menuItems[] = ['label' => 'Login', 'url' => ['/walmart/site/login']];
			} else {
				$menuItems[] = ['label' => 'Settings', 'url' => ['/walmart/walmartconfiguration/index']];
	        	...
	        	$menuItems[] = ['label' => 'Carrier Mapping', 'url' => ['/walmart/walmart-carriers-map/index']];
