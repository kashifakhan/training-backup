...
$url=\yii\helpers\Url::toRoute(['csvmap/udpateattributemap']);
$productfeedUrl= \yii\helpers\Url::toRoute(['csvmap/index']);
            ...
            success: function(json) {//transport
                ...
                if(json.error){
                    ...
                    j$.each(errors,function (index,value) {
                        var span = document.createElement('li');
                        span.innerHTML = '<img class="v-middle" src="<?php echo $error_img ?>"><span class="text">'+value+' : Product Attribute value not saved</span>';
                        span.id = 'id-'+id;
