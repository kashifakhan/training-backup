        ...
        <div class="csv_export col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="csv_import1">
                <form action="<?php echo $importUrl; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <select name="import" class="form-control csv-dropdown" id="action-dropdown2">
                        <option value="">Select Options</option>
                        <option value="price">Update Price</option>
                        <option value="qty">Update Inventory</option>
                        <option value="upc">Update Barcode</option>
                    ...
                    <div class="input-wrap clearfix">
                        ...
                        <input type="submit" class="btn btn-primary confirmbox" value="Import" id="import"/>
                    </div>
                </form>
            </div>
        </div>
            ...
            steps: [
                {
                    ...
                    intro: 'Select options like price, inventory and barcode which you want to export.',
                    position: 'right'
                },
                {
                    element: '#export',
                ...
                },
                {
                    ...
                    intro: 'Select options like price, inventory and barcode which you want to import.',
                    position: 'left'
                },
                {
                    element: '#browse',
        ...
        $(document).ready(function () {
            ...
            setTimeout(function () {
                productQuicktour.start().oncomplete(function () {
                    window.location.href = '<?= \frontend\modules\walmart\components\Data::getUrl("csvmap/index?tour") ?>';
                }, 1000);
            });
        });
    </script>
