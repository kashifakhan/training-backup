...
<script type="text/javascript">
    ...
    var i = 0;
//    var limit = prod.length / 10;

    var quantity_limit = <?php echo \frontend\modules\walmart\components\WalmartProduct::QTY_LIMIT ;?>;
    var limit =0;
    if(prod.length > quantity_limit){
        ...
        j$.ajax({
            ...
            success: function(json) {//transport
                ...
                if(json.success){
                    ...
                    span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span class="text">'+json.success.count+' Product InveUpdated of page '+id+'...</span>';
                    span.id = 'id-'+id;
