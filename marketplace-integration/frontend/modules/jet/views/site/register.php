...
<div class="site-register">
    ...
    <div class="content-section">
        <div class="register-heading">
            <strong>SETTING UP YOUR STORE</strong>
        </div>
        <div class="form new-section">
            <strong>ADMIN INFO</strong>
            <?php $form = ActiveForm::begin(['id'=> 'jetregistration-form']); ?>
                <?php //$form->field($model, 'skype') ?>
                <?= $form->field($model, 'mobile', ['options'=>['data-step'=>'1', 'data-position'=>'', 'data-intro'=>'<strong>Your Mobile No. Please..</strong>', 'data-tooltipClass'=>'intro-jet-mobile']]) ?>
                <?= $form->field($model, 'email', ['options'=>['data-step'=>'2', 'data-position'=>'', 'data-intro'=>'Your Email Please..']]) ?>
                <?= $form->field($model, 'plan_type')->dropDownList(['yearly'=>'yearly($299/year)','monthly'=>'monthly($30/month)',],['prompt'=>'Choose...']); ?>
                <?= $form->field($model, 'shipping_source[]')->checkboxList(['FBA' => 'FBA', 'Shipwork' => 'Shipwork', 'shipstation' => 'Shipstation', 'Other' => 'Other']); ?>
                <?= $form->field($model, 'product_count')->dropDownList(['1000'=>'0<1000','5000'=>'1000<5000','10000'=>'5000<10000','50000'=>'10000<50000',],['prompt'=>'Choose...']); ?>
                <?= $form->field($model, 'reference')->dropDownList(['Facebook'=>'Facebook','Google'=>'Google','Yahoo'=>'Yahoo','LinkedIn'=>'LinkedIn', 'YouTube'=>'YouTube', 'Other'=>'Other'],['prompt'=>'Choose...'])->label('Where did you here about us.'); ?>
                <?= $form->field($model, 'other_reference', ['options'=>['style'=>'display:none;']])->textarea()->label(""); ?>
                <label class="control-label" for="jetregistration-custom_price">Terms and conditions</label>
