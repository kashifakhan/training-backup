				...
				<div class="content-section">
					<div class="form new-section">
						...
						<ul>
							...
							<li>
								<p><b>Products not having SKU</b></p>
							</li>
							<li>
							<br>
							   <p><b>Haven't defined Product types for your store products ?!</b></p>	

						        <p>Login to your shopify store and visit product section then click the products which you want to define product types for</p>
						        <p> See In the below diagram</p>
						        <b>Note : However if you follow this method, you have to define product type for individual products</b>
						        <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/images/guide/product-type.png" alt="shopify-product-type"/>
						        <br>
						        <p>
						        	Too long, Right?! No problem,<br>You can define all product types at once with bulk product edit.
						        </p>
						...
						<p>After choosing the option ALL PRODUCTS/PUBLISHED PRODUCTS</p>
