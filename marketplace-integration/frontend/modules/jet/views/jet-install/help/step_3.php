			...
			<div class="col-lg-offset-2 col-md-offset-2 col-lg-8 col-md-8 col-sm-12 col-xs-12">
				<div class="content-section">
					...
					<h3 id="sec1">Live Api Details</h3>
		              ...
		              <p><b>Note:</b> Now that you’ve integrated your Shopify store with Jet.com, you need to import products from your store to the Cedcommerce Jet Integration app.</p>
					</div>
				</div>
			</div>
		</div>
