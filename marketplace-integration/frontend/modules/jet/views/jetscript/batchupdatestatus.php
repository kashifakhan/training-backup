<?php 
	...
	$url=\yii\helpers\Url::toRoute(['jetscript/batchstatusupdate']);
		...
		<div class="panel panel-default form new-section">
				<div class="jet-pages-heading">
					<div class="title-need-help">
						<h1 class="Jet_Products_style">Sync process from shopify store to app</h1>
					</div>
		...
		$.ajax({
        	...
        	success: function(json) 
        	{
				...
				if(id < pages){
					...
					var span = document.createElement('li');					
					span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span id="update_status" class="text"> Sync completed Successfully.'+'</span>';					
					span.style = 'background-color:#DDF';
