<?php 
	...
	/*if ($type=='category')
		$url=\yii\helpers\Url::toRoute(['jetproductslist/batchcategorystatusupdate']);
	else*/
		$url=\yii\helpers\Url::toRoute(['jetproductslist/batchstatusupdate']);
		...
		<div class="panel panel-default form new-section">
				<div class="jet-pages-heading">
					<div class="title-need-help">
						<h1 class="Jet_Products_style">Product Sync with Jet</h1>
					</div>
