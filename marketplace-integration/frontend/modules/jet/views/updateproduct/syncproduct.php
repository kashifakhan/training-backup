<?php 
	...
	if($param=='desc')	
		$url=\yii\helpers\Url::toRoute(['updateproduct/syncdescription']);
	else
		return
	...
	<div class="col-md-12" style="margin-top: 10px;">
		<div class="panel panel-default">
				<div class="jet-pages-heading">
					<h1 class="Jet_Products_style">Product Sync Status</h1>
		...
		j$.ajax({
        	...
        	success: function(json) {//transport
				...
				if(id < pages){
					...
					var span = document.createElement('li');
					if(notSku && notSku>0){
						span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span id="update_status" class="text">'+countOfSuccess+' Product(s) Successfully updated and '+notSku+' products unable to updated due to missing product sku(s).'+'</span>';
					}else{
