...
$urlManageProduct = \yii\helpers\Url::toRoute(['jetproduct/index']);
$urlMore = \yii\helpers\Url::toRoute(['jetvalidate/validate-more']);
$validation = new JetDataValidation;
?>
...
<div class="jet-product-index content-section">
  <div class="form new-section">
    <div class="jet-pages-heading ">
        ...
        <a class="btn btn-primary" onclick="viewMore()" id="more_validate" data-toggle="tooltip" title="Upload validated sku Or export invalid skus" data-step="8" data-position="left" data-intro="Back To Manage Product(s)">More</a>
      ...
      <?php foreach($data as $productId => $product):?>
          <div class="cards">
            <div class="pro-info">
              ...
              <span class="info"><a target="_blank" href="<?=$urlManageProduct?>?JetProductSearch[id]=<?=$productId;?>&_edt=<?=$productId;?>"><?=$product ['display_name'];?></a></span>
...
<div id="view_more" style="display: none;"></div>
<script>
