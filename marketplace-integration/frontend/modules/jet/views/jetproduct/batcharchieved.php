		...
		<div class="panel panel-default form new-section">
			<div class="jet-pages-heading">
				<div class="title-need-help">
					<h1 class="Jet_Products_style">Product Archive Status</h1>
				</div>
			...
			<div class="block-content panel-body shopify-api ">			
				<ul class="warning-div" style="margin-top: 66px">
					<li style="background-color:#Fff;">
						...
						Starting Product archive execution, please wait...
					</li>
					<li style="background-color:#FFD;">
						...
						Warning: Please do not close the window during Archiving data
					</li>
				</ul>
				...
				<ul id="profileRows">
					...
					<li id="liFinished" style="display:none;background-color:#Fff;">
						<img src="<?php echo yii::$app->request->baseUrl.'/frontend/images/batchupload/note_msg_icon.gif';?>" class="v-middle" style="margin-right:5px"/>
						Finished product archived execution.
					</li>
				</ul>
			</div>
		</div>     
...
<script type="text/javascript"> 
	...
	function uploaddata(){
		...
		$.ajax({
            url:"<?=\yii\helpers\Url::toRoute(['jetproduct/startbatcharchieved'])?>",
            method: "post",
            dataType:'json',
        	...
        	success: function(json) {//transport
				...
				if(id < totalRecords){
					...
					var span = document.createElement('li');
					span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span id="update_status" class="text">'+countOfSuccess+' Product(s) Successfully Archived Requested.'+'</span>';
					span.style = 'background-color:#DDF';
			...
			error: function(){
				...
				if(id < totalRecords){
					...
					status_image.src = '<?php echo $succes_img ?>';
					var span = document.createElement('li');
					span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span id="update_status" class="text">'+countOfSuccess+' Product(s) Successfully Archiveed.'+'</span>';
					span.style = 'background-color:#DDF';
					my_id.parentNode.insertBefore(span, my_id);
					$(".warning-div").hide();
					document.getElementById("liFinished").style.display="block";
