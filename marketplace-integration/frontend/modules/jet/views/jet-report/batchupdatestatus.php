<?php 
	...
	$getJsonUrl = \yii\helpers\Url::toRoute(['jet-report/processstatus']); 
	$url=\yii\helpers\Url::toRoute(['jet-report/batch-product-status']);
	$productUrl = \yii\helpers\Url::toRoute(['jetproduct/index']);;//\yii\helpers\Url::to(Yii::$app->request->referrer);
?>
<style type="text/css" >
