<?php 
	...
	$url = \yii\helpers\Url::toRoute(['jetproduct-fileupload/batchpriceupdate']);
		...
		<div class="panel panel-default form new-section">
				<div class="jet-pages-heading">
					<div class="title-need-help">
						<h1 class="Jet_Products_style"> Bulk Price Update On Jet</h1>
					</div>
		...
		$.ajax({
        	...
        	success: function(json) 
        	{
				...
				if(id < pages){
					...
					var span = document.createElement('li');
					if(notSku && notSku>0){
						span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span id="update_status" class="text">'+countOfSuccess+' Price Update file Successfully updated</span>';
					}else{
						span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span id="update_status" class="text">'+countOfSuccess+' Price Update file Successfully updated.'+'</span>';
					}
					span.style = 'background-color:#DDF';
