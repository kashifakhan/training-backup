...
class JetRegistrationSearch extends JetRegistration
{
     ...
     * @inheritdoc
     */
    public $installed_on,$expired_on;
    public function rules()
    {
        return [
            [['id', 'merchant_id'], 'integer'],
            [['name', 'shipping_source', 'other_shipping_source', 'mobile', 'email', 'reference', 'already_selling', 'api_provider_name', 'is_uninstalled_previous', 'agreement', 'other_reference','installed_on','expired_on'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'name', $this->name])
            ...
            ->andFilterWhere(['like', 'api_provider_name', $this->api_provider_name])
