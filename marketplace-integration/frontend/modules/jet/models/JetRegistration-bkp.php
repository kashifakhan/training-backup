 ...
 * @property string $api_provider_name
...
class JetRegistration extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['reference'], 'string'],
            [['name', 'shipping_source', 'email', 'agreement', 'other_reference', 'other_shipping_source','already_selling','api_provider_name','is_uninstalled_previous','installed_on','expired_on'], 'string', 'max' => 255],
            [['merchant_id'], 'unique'],
