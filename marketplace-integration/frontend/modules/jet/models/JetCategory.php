...
/**
 * This is the model class for table "jet_category".
 *
 * @property integer $id
 ...
 */
class JetCategory extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'merchant_id', 'title', 'parent_id', 'parent_title', 'root_id', 'root_title', 'level', 'jet_attributes'], 'required'],
            [['id', 'merchant_id', 'parent_id', 'root_id', 'level'], 'integer'],
	...
	public function get_categories()
    {
    	...
    	if(isset($session['category'])){
    		$data=json_decode($session['category'],true);
    	}
    	else{
