...
class Cronrequest extends Component
{
    ...
    const API_URL = 'https://api.newegg.com/marketplace/can';
...
//        self::log($server_output,$merchant_id);
        curl_close ($ch);
    ...
    public static function getRequest($url = '', $params = [], $config = [])
    {
        if($config){
            ...
            $url = 'https://api.newegg.com/marketplace/can/' . $url . "?sellerid=" . $config['seller_id'];
