        ...
        <div class="jet-pages-heading">
            ...
            <div class="product-upload-menu">
                ...
                <a class="btn btn-primary" id="fetch-newegg-orders" title="Fetch Newegg Order"
                   href="<?= Yii::$app->request->baseUrl; ?>/neweggcanada/neweggorderdetail/orderdetails">Fetch Newegg Order</a>
                <a class="btn btn-primary" id="sync-newegg-orders" title="Create newegg order in store"
                   href="<?= Yii::$app->request->baseUrl; ?>/neweggcanada/neweggorderdetail/syncorder">Synchronize
                    Newegg Orders</a>
                <a class="btn btn-primary" id="update-newegg-orders" title="Click here to sync order status from newegg"
                   href="<?= Yii::$app->request->baseUrl; ?>/neweggcanada/neweggorderdetail/updatestatus">Sync Order Status
                    </a>
