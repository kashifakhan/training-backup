...
<head>
	...
	<script type="text/javascript">
		...
		<link rel="stylesheet" href="<?= Yii::$app->getUrlManager()->getBaseUrl();?>frontend/modules/neweggcanada/assets/css/jQuery-plugin-progressbar.css">
		<link rel="stylesheet" href="<?= Yii::$app->getUrlManager()->getBaseUrl();?>frontend/modules/neweggcanada/assets/css/bootstrap-material-design.css">
		<link rel="stylesheet" href="<?= Yii::$app->getUrlManager()->getBaseUrl();?>frontend/modules/neweggcanada/assets/css/pie-chart.css">
		<script type="text/javascript" src="<?= Yii::$app->getUrlManager()->getBaseUrl();?>frontend/modules/neweggcanada/assets/js/pie-chart.js"></script>
		
		<link rel="stylesheet" href="<?= Yii::$app->getUrlManager()->getBaseUrl();?>frontend/modules/neweggcanada/assets/css/bootstrap.css">
		<link rel="stylesheet" href="<?= Yii::$app->getUrlManager()->getBaseUrl();?>frontend/modules/neweggcanada/assets/css/style.css">
	<script type="text/javascript">
