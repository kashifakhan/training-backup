...
use frontend\modules\neweggcanada\components\Upgradeplan;
use frontend\modules\neweggcanada\controllers\GetnotificationController;
...
<div class="wrap ced-jet-navigation-mbl">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="<?= Yii::$app->request->baseUrl ?>/neweggcanada/manufacturer/index">Manage
                                            Manufacturer</a></li>
                                </ul>
                            </li>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="<?= Yii::$app->request->baseUrl ?>/neweggcanada/categorymap/index">Map
                                            Category</a></li>
                                    <li>
                                        <a href="<?= Yii::$app->request->baseUrl ?>/neweggcanada/newegg-attributemap/index">Attributes
                                            Mapping</a></li>
                                    <li role="separator"></li>
                                    <li>
                                        <a href="<?= Yii::$app->request->baseUrl ?>/neweggcanada/neweggproduct/index">Manage
                                            Products</a></li>
                                    <li>
                                        <a href="<?= Yii::$app->request->baseUrl ?>/neweggcanada/newegg-valuemap/index">Attribute
                                            Value Mapping</a></li>
                                    <li>
                                        <a href="<?= Yii::$app->request->baseUrl ?>/neweggcanada/neweggproductfeed/index">Newegg
                                            Feeds</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="<?= Yii::$app->request->baseUrl ?>/neweggcanada/neweggorderdetail/index">Sales
                                            Order</a></li>
                                    <!--                                    <li><a href="-->
                                    <? //= Yii::$app->request->baseUrl ?><!--/neweggcanada/neweggorderdetail/getcourtesyrefund">Courtesy Refund Orders</a></li>-->
                                    <li>
                                        <a href="<?= Yii::$app->request->baseUrl ?>/neweggcanada/neweggorderimporterror/index">Failed
                                            Order</a></li>
                                </ul>
                            </li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                   aria-haspopup="true" aria-expanded="false">Import/Export<span
                                            class="caret"></span></a>
                                <ul class="dropdown-menu">
                                    <li><a href="<?= Yii::$app->request->baseUrl ?>/neweggcanada/productcsv/index">Product
                                            Update</a></li>
                                    <li><a href="<?= Yii::$app->request->baseUrl ?>/neweggcanada/updatecsv/index">Price,Inventory
                                            and Barcode</a></li>
                            ...
                            <li><a class="icon-items"
                                   href="<?= Yii::$app->request->baseUrl ?>/neweggcanada/neweggconfiguration/index"><img
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?= Yii::$app->request->baseUrl ?>/neweggcanada/site/paymentplan">Payment
                                            Plan</a></li>
                                    ...
                                    <li><a href="<?= Yii::$app->request->baseUrl ?>/neweggcanada/site/index?tour">Quick
                                            Tour</a></li>
                                    <li class="logout_merchant"><a
                                                href="<?= Yii::$app->request->baseUrl ?>/neweggcanada/site/logout">Logout</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                        ...
                        <ul class="nav navbar-nav navbar-right navbar-2">
                            ...
                            <li><a class="icon-items"
                                   href="<?= Yii::$app->request->baseUrl ?>/neweggcanada/neweggconfiguration/index">Setting</a>
                            </li>
    ...
    <div class="fixed-container-body-class">
        ...
        <?= Breadcrumbs::widget([
            'homeLink' => ['label' => 'Home', 'url' => Yii::$app->getUrlManager()->getBaseUrl() . '/neweggcanada/site/index'],
...
<!-- <div class="independence-day">
    <a class="usa-independence" href="<?= Yii::$app->request->baseUrl ?>/neweggcanada/site/paymentplan"><img
                src="<?= Yii::$app->request->baseUrl ?>/frontend/modules/neweggcanada/assets/images/usa.png"></a>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="skype">
                        <div class="icon-box">
                            <div class="image">
                                <a title="Click Here to Connect With us through Skype" href="javascript:void(0)"><img
...
<?php if (!\Yii::$app->user->isGuest && $valuecheck) { ?>
    ...
    <script type="text/javascript">
        ShopifyApp.init({
            apiKey: "<?php echo NEWEGGCANADA_APP_KEY;?>",
    ...
    <div class="inner-notification-pos">
        ...
        <div class="inner-notification-pos-scroll">
            <div class="notification-pos-scroll">
                 <?php echo (!Yii::$app->user->isGuest)?GetnotificationController::getNotification(Yii::$app->user->identity->id):'' ?>
            </div>
        </div>
    </div>
</div>
