...
use frontend\modules\neweggcanada\components\Neweggcategorytree;
use yii\web\Session;
...
<div class="category-map-index content-section">
    ...
    <form id="category_map" class="form new-section" method="post" action="<?= Data::getUrl('categorymap/save') ?>">
        ...
        <div style="display: none;border-radius: 4px;margin-bottom: 10px;padding: 10px;"
             class="help-block help-block-error top_error alert-danger">Please map atleast one product type with Newegg
            category to list products
        </div>
            ...
            <table id="map_producttype" class="table table-striped table-bordered">
                ...
                foreach ($model as $value) {
                    ...
                    <tr>
                        ...
                        <!--<td>
                            <input type="text" name="type[<?/*=trim($value->product_type)*/
