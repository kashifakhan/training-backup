...
<div class="site-register">
    <div class="content-section">
        <div class="">
            ...
            <?php $form = ActiveForm::begin(['id'=> 'neweggregistration-form','enableAjaxValidation' => true, 'enableClientValidation' => true]); ?>
               ...
               <div class="required">
                ...
                <?= Html::a('View & Download', Yii::$app->request->baseUrl.'/newegg-policy/newegg-policy.pdf', ['class'=>'btn btn-primary', 'target'=>'_blank']) ?>
...
<script type="text/javascript">
     var url = "<?= Data::getUrl('newegg-register/save') ?>";
     var saveFlag = false;
     $('#neweggregistration-form').on('submit', function(event) {
     ...
     $(".next").on('click', function(){
          $('#neweggregistration-form').data('yiiActiveForm').submitting = true;
          var resp = $('#neweggregistration-form').yiiActiveForm('validate');
     });
</script>
...
$(document).ready(function(){
     ...
     $('#neweggregistration-reference').change(function(){
        if($(this).val()=='Other') {
            $('#neweggregistration-other_reference').css('display', 'block');
            $('.field-neweggregistration-other_reference').css('display', 'block');
        } else {
            $('#neweggregistration-other_reference').val("");
            $('#neweggregistration-other_reference').css('display', 'none');
            $('.field-neweggregistration-other_reference').css('display', 'none');
        }
     });

     $('input[name="NeweggRegistration[shipping_source][]"]').on('click', function(){
          var OtherFlag = false;
          $('input[name="NeweggRegistration[shipping_source][]"]').each(function(){
