...
<div id="home-page">
    ...
    $this->registerCssFile(Yii::$app->request->baseUrl."/frontend/modules/neweggcanada/assets/css/creative.css");
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a class="page-scroll" href="<?php echo Yii::$app->request->baseUrl ?>/newegg-marketplace/sell-on-newegg" target="_blank">How to Sell on Newegg?</a>
                        </li>
                    </ul>
    ...
    <header class="header-section">
        ...
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <hr>
                <p>All in one platform for merchants to list products on Newegg Canada Marketplace and manage their inventory, order and shipping.</p>
        ...
        <meta property="og:image" content="https://shopify.cedcommerce.com/integration/frontend/modules/neweggcanada/assets/img/2bg_image1.png" />
        ...
        <link rel="canonical" href="https://shopify.cedcommerce.com/integration/neweggcanada/site/login" />-->
    </header>
                    ...
                    <div class="panels panels-shortcode">
                        <div class="panel-item margin-bottom-60">
                            ...
                            <div class="panels-text">
                                ...
                                Easy listing and fulfilment with tracking information of newegg orders from shopify store.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panels panels-shortcode wow bounceIn">
                        <div class="panel-item margin-bottom-60">
                            ...
                            <div class="panels-text">
                                ...
                                Realtime error handling is achieved with our app. If issues occur in any product uploaded on newegg.com, proper messages are shown in the notification section for errors.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panels panels-shortcode wow bounceIn">
                        <div class="panel-item margin-bottom-60">
                            ...
                            <div class="panels-text">
                                ...
                                Dashboard of our app gives the information about the total number of products uploaded on newegg.com, number of live and archived products along with the number of orders imported by the app and your shops lifetime sales.
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 text-center">
                    <div class="service-box">
                        ...
                        <p class="text-muted">Get notified automatically when any order is placed on newegg for your products!</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 text-center">
                    <div class="service-box">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 text-center">
                    <div class="service-box">
                        ...
                        <hr>
                        <h6>Up to Date</h6>
                        <p class="text-muted">Remain updated every time something new happens to your products on newegg.com.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 text-center">
                    <div class="service-box">
