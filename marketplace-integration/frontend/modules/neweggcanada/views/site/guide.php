...
$this->title = 'Documentation: How to Sell on Newegg.com?';
...
<header>
    ...
    <meta property="og:image" content="https://shopify.cedcommerce.com/integration/frontend/modules/neweggcanada/assets/images/newegg/step2.png" />
...
<!--          <img class="image-edit" src="--><?//= Yii::$app->request->baseUrl; ?><!--/images/walmart-guide/install-walmart-app.png" />-->
        ...
        <h2 id="sec1-1">Registration</h2> 
            <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/newegg-guide/step1.png" alt="registration-step"/>
        <p>
       <h3 id="sec1-2">Test Newegg Api</h3>
              ...
              <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/newegg-guide/step2.png" alt="registration-step2" />
        ...
        <hr>
          ...
          <h3 id="sec1-3">Product Import Section</h3>
            ...
            <ul>
              ...
              <li>
                <p><b>3. Haven't defined Product types for your store products ?!</b></p> 
                    ...
                    <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/guide/product-type.png" alt="shopify-product-type"/>
                    <br>
                    <p>
                    ...
                    <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/guide/bulk-edit-products.png" alt="bulk-edit-products"/>
                    <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/guide/bulk-edit-product-type.png" alt="bulk-edit-product-type"/>
                </li>    
              <li>
                <br>
            ...
            <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/newegg-guide/step3.png" alt="import-product" />
            <hr>
            ...
            <br>
                ...
                <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/newegg-guide/step4.png" alt="map-category-newegg"/>
            ...
            <br>
              ...
              <p>Now, in order to transfer correct information of your products on Newegg, you need to map Newegg attributes with your product variant options (attributes) .</p>
                <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/newegg-guide/step5.png" alt="newegg-attribute-mapping"/>
                
       <h2 id="sec2">Newegg Configuration Setting</h2>
       <h3 id="sec2-1">Newegg Setting</h3>
       <p>
        <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/newegg-guide/newegg_configuration.png" alt="newegg_configuration"/>
       </p>
      <hr>
      
      <h3 id="sec2-3">Cancel Order Setting</h3>
       <p>
        <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/newegg-guide/cancelsection.png" alt="newegg-order-section"/>
       </p>

       <h3 id="sec2-3">Email Subscription Setting</h3>
       <p>
        <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/newegg-guide/email_setting.png" alt="newegg-order-section"/>
       </p>
       ...
       <h2 id="sec4">Configure Products</h2>
        <p>
          ...
          <ul>
            <li>In Newegg-Integration app,<br><i>Go to the top menu and Click <b>PRODUCTS -> <a href="<?= Yii::$app->request->baseUrl; ?>/neweggcanada/neweggproduct/index" target="_self">MANAGE PRODUCTS</a></b>.</i></li>
            <li>
                ...
                <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/manage-product.png" alt="shopify-product-listing"/>
            ...
            <li>
	            <p> These products which are SOLO and do not have any other variations (Size, Color etc.) are called Simple Products (Non Variant).  
	             <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/edit-simple.png" alt="attribute-nonvariant"/>
            ...
            <li>
	            ...
	            <p> These products have different variations. There exist ONE parent product category and rest of the products are children.
		            <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/edit.png" alt="attribute-variant-new"/>
        ...
        <h2 id="sec5">Manage Products</h2>
        	<p>After all the products are properly edited. Means products have their Barcode (UPC, ISBN-10,ISBN-13,GTIN-14) or ASIN, Quantity and Attribute values, Price information, products can be uploaded at once.<br>Go to top menu, Click <b>Manage Products -><a href="<?= Yii::$app->request->baseUrl; ?>/neweggcanada/neweggproduct/index" target="_self"> Upload Products</a></b><br>All the products that uploaded till now are listed here.<br>Tick all the check boxes on the leftmost column, thereafter Select <b>Upload </b> and Click <b>SUBMIT</b>.</p>
        ...
        <h3 id="sec5-1">Upload Products</h3>
         <p>
          <b>Select the product, choose upload and Click Submit.</b> 
         	<img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/newegg-guide/uploadproduct.png" alt="manage-product" />
			...
			<img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/status-bar.png" alt="status_bar"/>
        	<p>
        ...
        <p>
        <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/product-feed.png" alt="status_bar"/>
        </p>
        ...
        <hr>
         ...
         <h2 id="sec6">Order Management</h2>
            ...
            <p>
                ...
                <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/sales-order.png" alt="order-listing"/>
            </p>
            
            <h3 id="sec6-3">Failed Orders</h3>
            <p>
                In the case quantity is not available in Shopify store or product SKU doesn’t exist) app does not fetch order from Newegg.com. For checking details of failed orders<br> Open <b>Orders -> <a href="<?= Yii::$app->request->baseUrl; ?>/neweggcanada/neweggorderimporterror/index" target="_self">Failed Order</a></b> section.
                <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/failed-orders.png" alt="failed-orders-list" />
        ...
        <hr>
            ...
            <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/emailsubscription.png" alt="emailsubscription"/>
        </div><!--/right-->
    </div><!--/row-->
</div><!--/container-->
</div>
 ...
 <?php $this->registerCssFile(Yii::$app->request->baseUrl."/frontend/modules/neweggcanada/assets/css/setup-styles.css"); ?>
 <?php $this->registerJsFile(Yii::$app->request->baseUrl.'/frontend/modules/neweggcanada/assets/js/setup-scripts.js'); ?>
