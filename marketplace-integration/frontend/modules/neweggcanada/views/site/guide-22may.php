...
<!--          <img class="image-edit" src="--><?//= Yii::$app->request->baseUrl; ?><!--/images/walmart-guide/install-walmart-app.png" />-->
        ...
        <h2 id="sec1-1">Registration</h2> 
            <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/step1.png" alt="registration-step"/>
        <p>
       <h3 id="sec1-2">Test Newegg Api</h3>
              ...
              <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/step2.png" alt="registration-step2" />
        ...
        <hr>
          ...
          <h3 id="sec1-3">Product Import Section</h3>
            ...
            <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/step3.png" alt="import-product" />
            <hr>
       ...
       <p>
        <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/newegg_configuration.png" alt="newegg_configuration"/>
       </p>
      <hr>
      
      <h3 id="sec2-3">Newegg Order Settings</h3>
       <p>
        <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/cancelsection.png" alt="newegg-order-section"/>
       </p>
        ...
        <h3 id="sec5-1">Upload Products</h3>
         <p>
          <b>Select the product, choose upload and Click Submit.</b> 
         	<img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggcanada/assets/images/newegg/manage-product.png" alt="manage-product" />
