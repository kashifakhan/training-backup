 ...
 * Time: 4:59 PM
 */
use frontend\modules\neweggcanada\components\Dashboard\Earninginfo;
use frontend\modules\neweggcanada\components\Dashboard\Productinfo;
use frontend\modules\neweggcanada\components\Dashboard\OrderInfo;
use frontend\modules\neweggcanada\components\Dashboard\LatestUpdates;
use frontend\modules\neweggcanada\components\Dashboard\Stockinfo;
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="live-box new-section grey-bg">
                                                        ...
                                                        <div class="product-count">
                                                            ...
                                                            <a href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggproduct/index?NeweggProductSearch[upload_status]=ACTIVATED"><span>know more</span></a>
                                                            <a class="icon" href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggproduct/index?NeweggProductSearch[upload_status]=ACTIVATED"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="jet-review-box new-section purple-bg">
                                                        ...
                                                        <div class="product-count">
                                                            ...
                                                            <a href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggproduct/index?NeweggProductSearch[upload_status]=SUBMITTED"><span>know more</span></a>
                                                            <a class="icon" href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggproduct/index?NeweggProductSearch[upload_status]=SUBMITTED"><i class="fa fa-binoculars" aria-hidden="true"></i>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="missing-listings new-section purple-bg">
                                                        ...
                                                        <div class="product-count">
                                                            ...
                                                            <a href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggproduct/index?NeweggProductSearch[upload_status]=DEACTIVATED"><span>know more</span></a>
                                                            <a class="icon" href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggproduct/index?NeweggProductSearch[upload_status]=DEACTIVATED"><i class="fa fa-question-circle-o" aria-hidden="true"></i>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="archieves new-section grey-bg">
                                                        ...
                                                        <div class="product-count">
                                                            ...
                                                            <a href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggproduct/index?NeweggProductSearch[upload_status]=UPLOAD+WITH+ERROR"><span>know more</span></a>
                                                            <a class="icon" href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggproduct/index?NeweggProductSearch[upload_status]=UPLOAD+WITH+ERROR"><i class="fa fa-folder-open" aria-hidden="true"></i>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="not-uploaded new-section black-bg">
                                                        ...
                                                        <div class="upload-wrap">
                                                            ...
                                                            <div class="right">
                                                                <a class="icon" href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggproduct/index?NeweggProductSearch[upload_status]=Not+Uploaded"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i></a>
                                                                <a href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggproduct/index?NeweggProductSearch[upload_status]=Not+Uploaded"><span>know more</span></a>
                                                            </div>
                                                            <div class="clear"></div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="live-box new-section grey-bg">
                                                        ...
                                                        <div class="product-count">
                                                            ...
                                                            <a href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggorderdetail/index?NeweggOrderDetailSearch[order_status_description]=Shipped"><span>know more</span></a>
                                                            <a class="icon" href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggorderdetail/index?NeweggOrderDetailSearch[order_status_description]=Shipped"><i class="fa fa-list-alt" aria-hidden="true"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="jet-review-box new-section purple-bg">
                                                        ...
                                                        <div class="product-count">
                                                            ...
                                                            <a href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggorderdetail/index?NeweggOrderDetailSearch[order_status_description]=Unshipped"><span>know more</span></a>
                                                            <a class="icon" href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggorderdetail/index?NeweggOrderDetailSearch[order_status_description]=Unshipped"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="missing-listings new-section purple-bg">
                                                        ...
                                                        <div class="product-count">
                                                            ...
                                                            <a href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggorderdetail/index?NeweggOrderDetailSearch[order_status_description]=Voided"><span>know more</span></a>
                                                            <a class="icon" href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggorderdetail/index?NeweggOrderDetailSearch[order_status_description]=Voided"><i class="fa fa-window-close-o" aria-hidden="true"></i>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="archieves new-section grey-bg">
                                                        ...
                                                        <div class="product-count">
                                                            ...
                                                            <a href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggorderimporterror/index"><span>know more</span></a>
                                                            <a class="icon" href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggorderimporterror/index"><i class="fa fa-thumbs-o-down" aria-hidden="true"></i>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="not-uploaded new-section black-bg">
                                                        ...
                                                        <div class="product-count">
                                                                ...
                                                                <a class="icon" href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggorderdetail/index"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i></a>
                                                                <a href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggorderdetail/index"><span>know more</span></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <ul class="update-list list-style">
                                                ...
                                                <?php if($productsWithLowStock['count']>0){?>
                                                    ...
                                                    <?php foreach($productsWithLowStock['title'] as $value){?>
                                                        <li>
                                                            <p>Attention !<a href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggproduct/index?NeweggProductSearch[title]=<?=urlencode($value);?>"> <?=$value?></a></p>
                                                    ...
                                                    <?php if($productsWithLowStock['count'] > 3){?>
                                                        <li>
                                                            <a class="btn btn-primary" href="<?=Yii::$app->request->baseUrl;?>/neweggcanada/neweggproduct/index?low=<?=$productsWithLowStock['minQty']?>" target="_blank">Check For More</a>
                                                        </li>
                                                    <?php }?>
                                                <?php }else{?>
                                                    <li>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="tool-box-section new-section no-pad">
                            ...
                            <div class="tool-box-content">
                                ...
                                <a class="tool-box-content-a" href="<?/*= Yii::$app->request->baseUrl */?>/neweggcanada/neweggproduct/index?NeweggProductSearch[status]=Not+Uploaded"><span>Upload New Products </span></a>
                            </div>
                        </div>
