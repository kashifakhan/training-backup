...
$ipmort_url = Yii::$app->request->baseUrl . '/neweggcanada/neweggproduct/index';

$url = \yii\helpers\Url::toRoute(['/neweggcanada/neweggproduct/shopifyproductsync']);
$productUrl = \yii\helpers\Url::toRoute(['/neweggcanada/neweggproduct/index']);
