...
$ipmort_url=Yii::$app->request->baseUrl.'/neweggcanada/updatecsv/index';

$url=\yii\helpers\Url::toRoute(['updatecsv/inventoryupdate']);
        ...
        j$.ajax({
            ...
            success: function(json) {
                ...
                if(json.success) {
                    ...
                    span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span class="text">'+json.count+' Product(s) inventory feed successfully submitted on walmart of page '+id+'.</span>';
                ...
                if(json.error){
                    ...
                    if(json.feedError && json.feedError.hasOwnProperty('error'))
                    {
                        var span = document.createElement('li');
