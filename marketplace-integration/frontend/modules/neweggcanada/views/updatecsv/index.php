...
?>
                ...
                <div class="csv_import1">
                    <form action="<?php echo \yii\helpers\Url::toRoute(['updatecsv/export']); ?>" method="post">
                        ...
                        <div id = "dropdowns">
                            ...
                            <select name="status[]" multiple="multiple" class="form-control csv-dropdown" id="status-dropdown">
    ...
    <script type="text/javascript">
        ...
        $("#action-dropdown1").change(function () {
            var end = this.value;
            if(end){
//                $('#status-dropdown').css('displaynone');
