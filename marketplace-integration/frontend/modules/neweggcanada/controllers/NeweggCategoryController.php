...
use frontend\modules\neweggcanada\models\NeweggCategorySearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * NeweggCategoryController implements the CRUD actions for NeweggCategory model.
 */
class NeweggCategoryController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new NeweggCategorySearch();
