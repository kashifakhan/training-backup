...
<style>
  ...
  background-image: url("https://shopify.cedcommerce.com/integration/frontend/modules/neweggmarketplace/assets/images/star.png");
					...
					<div class="text-center">
						...
						<div class="row">
							<div class="bfs-pricing">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 bfs-pricing-col first">
									<img src="<?= Yii::$app->request->getBaseUrl()?>/frontend/modules/neweggmarketplace/assets/images/then.png" class="img-responsive center-block" alt="">
									<!-- <p>Then,</p>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 bfs-pricing-col second">
									<img src="<?= Yii::$app->request->getBaseUrl()?>/frontend/modules/neweggmarketplace/assets/images/now.png" class="img-responsive center-block" alt="">
								<!-- 	<p>Now,</p>
						...
						<div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12">
							<div class="bfs-button-col text-center">
								<a href="<?= Yii::$app->request->getBaseUrl().'/neweggmarketplace/site/paymentplan?plan=3' ?>">
