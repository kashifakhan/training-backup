...
<div id="home-page">
    ...
    $this->registerCssFile(Yii::$app->request->baseUrl."/frontend/modules/neweggmarketplace/assets/css/creative.css");
        ...
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <?php $form = ActiveForm::begin([
                    ...
                    'action' => \yii\helpers\Url::toRoute(['/neweggmarketplace/site/login']),
                    'fieldConfig' => [
