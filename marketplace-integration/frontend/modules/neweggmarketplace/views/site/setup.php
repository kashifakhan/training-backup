    ...
    <div class="row">
      ...
      <div class="col-md-9">
        ...
        <p>
          ...
          <ul>
            <li>First of all go to the Shopify app panel and after login you can see the top menu <b> JET -> Manage Products -> <a href="https://shopify.cedcommerce.com/frontend/neweggproduct/index" target="_blank">Upload Products</a> </b>. After going to upload products you can see all the shopify products listed on our app. </li>
            <li>
        ...
        <p>After editing all the products properly means. Each products must have their UPC, Quantity, Attribute values, Price information. Then you can upload products at once. Go to the top menu <b>Jet -> Manage Products -> <a href="https://shopify.cedcommerce.com/frontend/neweggproduct/index" target="_blank">Upload Products</a></b>. By going to this page you can find all the products now you can upload the products. On the left most column tick all the checkboxes in the product list. After selection Upload / Archive / Unarchive then click on submit.</p>
