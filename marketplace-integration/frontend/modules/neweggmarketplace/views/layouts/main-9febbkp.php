...
<head>
 ...
 <?php if(Yii::$app->controller->action->id=='pricing'){
    ...
    <?php 	NavBar::begin([
	        ...
	        $menuItems = [['label' => 'Home', 'url' => ['/neweggmarketplace/site/index']]];

			if (Yii::$app->user->isGuest) {
	        	$menuItems[] = ['label' => 'Login', 'url' => ['/neweggmarketplace/site/login']];
			} else {
				$menuItems[] = ['label' => 'Newegg Settings', 'url' => ['/neweggmarketplace/neweggconfiguration/index']];
	        	 		
	        	$menuItems[] = ['label' => 'Manage Products',			        	 		
			        	 		'items' =>
			        	 		[
			        	 			['label' => 'Map Category','url' => ['/neweggmarketplace/categorymap/index'] ],
			        	 			['label' => 'Attribute Mapping', 'url' => ['/neweggmarketplace/neweggattributemap/index']],
			        	 			
			        	 			['label' => 'Upload Products', 'url' => ['/neweggmarketplace/product/index']],
			        	 			['label' => 'Newegg Feeds', 'url' => ['/neweggmarketplace/neweggproductfeed/index']]
//			        	 			['label' => 'Get Taxcodes', 'url' => ['/walmart/walmarttaxcodes/index']],
				...
				$menuItems[] = ['label' => 'Manage Order',
					        	'items' =>
					        	[
					        		['label' => 'Orders Details', 'url' => ['/neweggmarketplace/neweggorderdetail/index']],
					        	 	['label' => 'Courtesy Refund Orders', 'url' => ['/neweggmarketplace/neweggorderdetail/getcourtesyrefund']],
					        	 	['label' => 'Order Import Error', 'url' => ['/neweggmarketplace/neweggorderimporterror/index']],
					        	],
	        	 			];
	        	
	        	$menuItems[] = [
	        	 				'label' => 'Logout (' . Yii::$app->user->identity->username . ')',
	        	 				'url' => ['/neweggmarketplace/site/logout'],
