                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="<?= Yii::$app->request->baseUrl ?>/neweggmarketplace/product/index">Manage Products</a></li>
                        ...
                        <ul class="nav navbar-nav navbar-right navbar-2">
                            ...
                            <li ><a class="icon-items" href="<?= Yii::$app->request->baseUrl ?>/neweggmarketplace/neweggconfiguration/index">Setting</a></li>
