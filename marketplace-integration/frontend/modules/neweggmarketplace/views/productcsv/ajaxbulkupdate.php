...
$ipmort_url=Yii::$app->request->baseUrl.'/neweggmarketplace/productcsv/index';

$url=\yii\helpers\Url::toRoute(['productcsv/batchupdate']);
...
//                    console.log(json.success);
                ...
                if(json.error){
                    ...
                    var span = document.createElement('li');
                    span.innerHTML = '<img class="v-middle" src="<?php echo $error_img ?>"><span class="text">'+errors+' : Invalid product Data</span>';
                    span.id = 'id-'+id;
