...
$ipmort_url=Yii::$app->request->baseUrl.'/neweggmarketplace/neweggorderdetail/index';

$url=\yii\helpers\Url::toRoute(['neweggorderdetail/updateorderstatus']);
$productfeedUrl= \yii\helpers\Url::toRoute(['neweggorderdetail/index']);
?>
<style type="text/css" >
        ...
        <div class="panel panel-default form new-section">
            <div class="jet-pages-heading">
                <div class="title-need-help">
                    <h1 class="Jet_Products_style">Update Order Status</h1>
                </div>
            ...
            <div class="block-content panel-body shopify-api ">
                <ul class="warning-div" style="margin-top: 18px">
                    <li style="background-color:#Fff;">
                        ...
                        Starting Update Order status execution, please wait...
                    </li>
                    <li style="background-color:#FFD;">
                        ...
                        Warning: Please do not close the window during Order update
                    </li>
                </ul>
                ...
                <ul id="profileRows">
                    ...
                    <li id="liFinished" style="display:none;background-color:#Fff;">
                        <img src="<?php echo yii::$app->request->baseUrl.'/frontend/images/batchupload/note_msg_icon.gif';?>" class="v-middle" style="margin-right:5px"/>
                        Finished Update Order status execution.
                    </li>
                </ul>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function updatefeeddata(){
        percent = getPercent();
        update_status.innerHTML = percent+'% Page '+(id+1)+' Of total order(s) pages '+pages+' Processing';
        j$.ajax({
            url:"<?= $url?>",
            method: "post",
            dataType:'json',
            ...
            success: function(json) {//transport
                ...
                if(json.success){
                    ...
                    span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span class="text">'+json.success.count+' order Updated of page '+id+'...</span>';
                    span.id = 'id-'+id;
                ...
                if(id < pages){
                    ...
                    span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span id="update_status" class="text">'+countOfSuccess+' order(s) Successfully Updated.'+'</span>';
            ...
            error: function(){
                ...
                if(id < pages){
                    ...
                    status_image.src = '<?php echo $succes_img ?>';
                    var span = document.createElement('li');
                    span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span id="update_status" class="text">'+countOfSuccess+' order(s) Successfully Uploaded.'+'</span>';
                    span.style = 'background-color:#DDF';
                    my_id.parentNode.insertBefore(span, my_id);
                    //$('liFinished').show();
                    j$(".warning-div").hide();
