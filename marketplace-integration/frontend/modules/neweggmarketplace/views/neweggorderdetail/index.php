    ...
    <div class="form new-section">
        <div class="jet-pages-heading">
            ...
            <div class="product-upload-menu">
                ...
                <a class="btn btn-primary" id="fetch-newegg-orders" title="Fetch Newegg Order"
                   href="<?= Yii::$app->request->baseUrl; ?>/neweggmarketplace/neweggorderdetail/orderdetails">Fetch Newegg Order</a>
                <a class="btn btn-primary" id="sync-newegg-orders" title="Create newegg order in store"
                   href="<?= Yii::$app->request->baseUrl; ?>/neweggmarketplace/neweggorderdetail/syncorder">Synchronize
                    Newegg Orders</a>
                <a class="btn btn-primary" id="update-newegg-orders" title="Click here to sync order status from newegg"
                   href="<?= Yii::$app->request->baseUrl; ?>/neweggmarketplace/neweggorderdetail/updatestatus">Sync Order Status
                    </a>
                ...
                'summary' => '<div class="summary clearfix">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                    <div class="bulk-action-wrapper">
                                        <a href="' . Yii::$app->request->getBaseUrl() . "/neweggmarketplace/neweggorderdetail/index" . '" class="btn btn-primary reset-filter">Reset</a>
                                    </div>
                                </div>
                             </div>',
                    ...
                    [
                        ...
                        'buttons' => [
                            ...
                            'shiporder' => function ($ship, $model) {
                                if (($model->order_status_description == 'Unshipped' && !empty($model->shopify_order_name)) /*|| ($model->status=='inprogress' )*/) {
                                    return Html::a(
    ...
    $(function () {
        ...
        var introBulkAction = introJs().setOptions({
            ...
            steps: [
                ...
                {
                    element: '#update-newegg-orders',
                    intro: " Click here to sync order status from newegg.",
                    position: 'bottom'
                }/*,
                {
                    element: '.view-order',
