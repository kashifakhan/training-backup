                ...
                <div class="content-section">
                    <div class="form new-section">
                        ...
                        <div>
                            ...
                            <img class="image-edit"
                                 src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggmarketplace/assets/images/newegg/manufacturer.png"
                                 alt="configuration-settings"/>
                        ...
                        <div>
                            ...
                            <img class="image-edit"
                                 src="<?= Yii::$app->request->baseUrl; ?>/frontend/modules/neweggmarketplace/assets/images/newegg/manufactures_name.png"
                                 alt="configuration-settings"/>
                        </div>
                    </div>
                </div>
