...
// use frontend\modules\neweggmarketplace\components\Validation;
...
class NeweggMainController extends Controller
{
    ...
    */
    ...
    public function init()
    {
        ...
        {
            Yii::$app->errorHandler->errorAction = '/neweggmarketplace/site/neweggerror';
    ...
    public function beforeAction($action)
    {
        ...
        if (!Yii::$app->user->isGuest) {
            ...
            $data = Data::sqlRecords("SELECT * FROM `newegg_shop_detail` WHERE merchant_id='" . $merchant_id . "'", 'one');
            ...
            $this->redirect(Yii::$app->getUrlManager()->getBaseUrl().'/neweggmarketplace/site/login',302);
            return false;
        }
            ...
            if (strtotime($data['expire_date']) < strtotime($current_date) ) {
                if (isset($data['install_status']) && $data['install_status'] == 0) {
                    ...
                    $neweggShopDetailModel = new NeweggShopDetail();
                        ...
                        $this->redirect(Yii::$app->getUrlManager()->getBaseUrl().'/neweggmarketplace/site/paymentplan',302);
                        return true;
