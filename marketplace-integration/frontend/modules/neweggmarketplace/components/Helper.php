...
class Helper extends Component
{
     ...
     *				 $url = www.baseurl.com/neweggmarketplace/post/index
     * 
     * @param $path string
     * @return string
     */
    ...
    public static function configurationDetail($merchant_id){
       $query='select seller_id,authorization,secret_key,manufacturer from `newegg_can_configuration` where merchant_id="'.$merchant_id.'"';
