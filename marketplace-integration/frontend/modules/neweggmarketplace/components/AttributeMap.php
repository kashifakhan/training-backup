...
class AttributeMap extends Component
{
    ...
    public static function getShopifyProductTypes($merchant_id = null)
    {
        ...
        $query = "SELECT `product_type`,`category_path`,`category_id` FROM `newegg_category_map` WHERE `category_path`!='' AND `merchant_id`=" . $merchant_id;
    ...
    public static function getAttributeMapValues($product_type, $merchant_id = null)
    {
        ...
        $query = 'SELECT `shopify_product_type`,`newegg_category_id`,`attribute_map_data`,`attribute_map` FROM `newegg_attribute_map` WHERE `shopify_product_type`="' . $product_type . '" AND `merchant_id`=' . $merchant_id;
