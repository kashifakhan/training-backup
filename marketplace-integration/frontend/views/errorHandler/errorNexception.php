...
//fwrite($fh, '<pre>'.print_r($this,true).'</pre>');
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <?php if (isset(Yii::$app->user->isGuest) && Yii::$app->user->isGuest) {
                                ?>
                                <li><a href="<?= Yii::$app->request->baseUrl ?>/walmart/site/pricing">Pricing</a></li>
                                <li><a href="<?= Yii::$app->request->baseUrl ?>/walmart/site/guide">Documentation</a>
                                </li>
                                <li><a href="<?= Yii::$app->request->baseUrl ?>/walmart/site/login">Login</a></li>
                            <?php } else {
                                ?>
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="<?= Yii::$app->request->baseUrl ?>/walmart/categorymap/index">Map
                                                Category</a></li>
                                        <li>
                                            <a href="<?= Yii::$app->request->baseUrl ?>/walmart/walmart-attributemap/index">Attributes
                                                Mapping</a></li>
                                        <li><a href="<?= Yii::$app->request->baseUrl ?>/walmart/walmartproduct/index">Manage
                                                Products</a></li>
                                        <li role="separator"></li>
                                        <li><a href="<?= Yii::$app->request->baseUrl ?>/walmart/walmarttaxcodes/index">Get
                                                Taxcodes</a></li>
                                        <li>
                                            <a href="<?= Yii::$app->request->baseUrl ?>/walmart/walmartproductfeed/index">Walmart
                                                Feeds</a></li>
                                ...
                                <li>
                                    <a href="<?= Yii::$app->request->baseUrl ?>/walmart/walmart-carriers-map/index">Carrier
                                        Mapping</a>
                                </li>
                                <li>
                                    <a href="<?= Yii::$app->request->baseUrl ?>/walmart/faq/index">FAQs</a>
                                </li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="<?= Yii::$app->request->baseUrl ?>/walmart/csvmap/index">Attribue
                                                Mapping</a></li>
                                        <li>
                                            <a href="<?= Yii::$app->request->baseUrl ?>/walmart/updatecsv/index-retire">Retire Product</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    <a class="icon-items"
                                       href="<?= Yii::$app->request->baseUrl ?>/walmart/walmartconfiguration/index"><img
                                                src="<?= Yii::$app->request->baseUrl ?>/images/setting.png"></a>
                                </li>
                                <li class="dropdown ">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="<?= Yii::$app->request->baseUrl ?>/walmart-marketplace/paymentplan">Payment
                                                Plan</a></li>
                                        <li><a href="http://support.cedcommerce.com/">Support</a></li>
                                        <li>
                                            <a href="<?= Yii::$app->request->baseUrl ?>/walmart-marketplace/sell-on-walmart">Documentation</a>
                                        </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="skype">
                        <div class="icon-box">
                            <div class="image">
                                <a title="" href="javascript:void(0)"><img
    ...
    <div class="copyright-section">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <a title="Click Here to Submit a Support Ticket"
