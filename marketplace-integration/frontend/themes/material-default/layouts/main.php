...
?>
  ...
  <nav class="light-blue lighten-1" role="navigation">
    <div class="container">
      <div class="nav-wrapper"><a id="logo-container" href="#" class="brand-logo">BLOG</a>
	  		<?php
						echo Menu::widget([
						    ...
						    'items' => [
						        ...
						        ['label' => 'Login', 'url' => ['site/login'], 'visible' => Yii::$app->user->isGuest],
						    		...
						    		['label' => 'LOG OUT', 'url' => ['site/logout'],'visible' => !Yii::$app->user->isGuest,'linkOptions' => ['data-method' => 'post']],
