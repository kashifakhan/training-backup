...
$arrAction=array('email'=>'Email','validate_sku'=>'Validate Sku');
?>
    ...
    <?php 
                echo GridView::widget([
                    ...
                    'columns' => [
                            ...
                            'email',
                             ['attribute'=>'status',
                                 'filter'=>ArrayHelper::map(JetExtensionDetail::find()->all(),'status','status'),
                                ],
                              ['attribute'=>'app_status',
                             'filter'=>ArrayHelper::map(JetExtensionDetail::find()->all(),'app_status','app_status'),
