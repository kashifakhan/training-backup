...
<div class="review-product-index">
   ...
   <select>
       <option <?= $type=='daily'?'selected="selected"':'' ?> onclick="window.location ='<?= Yii::$app->urlManagerFrontEnd->createUrl(['admin/reports/installations/index','type'=>'daily']) ?>'" >Daily</option>
       <option <?= $type=='monthly'?'selected="selected"':'' ?> onclick="window.location ='<?= Yii::$app->urlManagerFrontEnd->createUrl(['admin/reports/installations/index','type'=>'monthly']) ?>'">Monthly</option>
       <option <?= $type=='yearly'?'selected="selected"':'' ?> onclick="window.location ='<?= Yii::$app->urlManagerFrontEnd->createUrl(['admin/reports/installations/index','type'=>'yearly']) ?>'">Yearly</option>
   </select>
