...
$this->title = 'Merchants Free But No Revenue And No Live Products ';
$this->params['breadcrumbs'][] = $this->title;
$arrAction=array('email'=>'Email');
?>
<div class="review-product-index">
<?=Html::beginForm(['free-no-revenue-no-live/mass'],'post',['id'=>'mass_action']);?>
                ...
                echo GridView::widget([
                    ...
                    'columns' => [
                            ...
                            ['attribute'=>'install_status',
                                'filter'=>array("1"=>"Installed","0"=>"Uninstalled"),
