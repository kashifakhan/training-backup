...
<div class="container-fluid">
    ...
    <!-- <iframe width="100%" height="445" style="align-items: center; padding: 10px;" src="https://www.youtube.com/embed/vvRPjZ5nDhc">
        ...
        <p>
            ...
            <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/images/guide/configuration-settings-new.png" alt="configuration-settings-new"/>
        <p>
       <h3 id="sec1-2">Test Api Details</h3>
          ...
          <h3 id="sec1-4">Product Import Section</h3>
            ...
            <br>
                ...
                <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/images/guide/map-category-jet.png" alt="map-category-jet"/>
       ...
       <h2 id="sec2"><b>Home</b></h2>
        ...
        <h3 id="sec3-1">Map Category</h3>
         <p>
          <b>Map the products in correct category so that they can sell more.</b> 
			...
			Jet maps product in category and then subcategory. It means- </br><b>PARENT -> CHILD -> GRANDCHILD.</b></br></br>The chances of getting order increases if you have mapped your product in correct category.</br>1) Just map your products and then click on SUBMIT.</br>2) after submittion you will redirect to manage products section.</br><b><h4><u>Note-</u></h4>You can search product on jet and then find correct category to map your products.</b></br>
        ...
        <h3 id="sec3-2">Map Jet Attributes</h3>
        	<p>
        		...
        		Variant Products mean, products having various attributes like color, size, metal etc. It is neccessary to do correct attribute mapping because <b>if it is not done your products will not be published on jet.</b> Jet provides you attribute so that you can correctly map your shopify attribues with jet attributes.</br><br>1) Just map your product with correct attribute</br>2) Click on save button and you are done.</br>
            </p>
         ...
         <h2 id="sec3-3">Manage Products</h2>   
             ...
             <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/images/guide/un-archieve-product.png" alt="un-archieve-product"/>
             <p>
             	<h4>
        ...
        <h3 id="sec7-4">Quick Tours</h3>
          ...
          Go to top, Click<b> Orders -> <a href="<?= Yii::$app->request->baseUrl; ?>/jetorderimporterror/index" target="_self">Failed Order</a></b> Order and Click Cancel order option. And fill Order Item ID and Merchant Order ID details.
        	...
        	<h3 id="sec6-6">Manage Returns</h3>
            <p>
                Jet returns can be viewed in return order area of the app.
                click<b> Orders -><a href="<?= Yii::$app->request->baseUrl; ?>/jetreturn/index" target="_self">Return Order</a></b><br>
                Here all the returns are listed. 
            </p>
            <p>
                Only those returns whose status shows created can be updated(processed).<br> Choose <b>Agree/Disagree</b> for the return.<br> In <b>Agree</b> condition, <b>refund amount</b> for the product is to be paid.<br> Either pay the full amount or partial amount of the product. In case of partial money returns, the reason for same MUST be documented. 
            </p>
			
            <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/images/guide/manage-order.png" alt="manage-order"/>
            <p>
               After Clicking <b>Update</b> icon, below screen is shown. Here <b>Agree/Disagree</b> for the return and pay for the returns.
			</p>
            <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/images/guide/manage-order-edit.png" alt="manage-order-edit" />
        	<hr>
        	
        	
        	
        	<h3 id="sec6-7">Manage Refunds</h3>
            <p>
                Jet refunds can be viewed in refund order area of the app. 
                Click<b> Orders -><a href="<?= Yii::$app->request->baseUrl; ?>/jetrefund/index" target="_self">Refund Order</a></b><br>
                Here all the refunds are listed.
            </p>
            <img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/images/guide/product-refund-1.png" alt="product-refund-1"/>
			<p>
				After Clicking '<b>Create Jet Refund</b>', below screen is shown. File a request here to Jet.com for the <b>refund</b>. Fill the form with details as <b>merchant order id</b>, refund quantity, refund reason etc.
			</p>
			<img class="image-edit" src="<?= Yii::$app->request->baseUrl; ?>/images/guide/product-refund-2.png" alt="product-refund-2"/>
        	</div><!--/right-->
    </div><!--/row-->
</div><!--/container-->
</div>
