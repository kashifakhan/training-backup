                    ...
                    if(preview) {
                        ...
                        withPreviewThumb(files[i], function (image) {
                            ...
                            $('<li></li>')
                                ...
                                .append('<input class="input-name form-control image-value" style="width:20%;text-align:center;margin-left:25px;margin-top:5px" name='+name+' id="image-position-'+count+'" value='+count+'>')
