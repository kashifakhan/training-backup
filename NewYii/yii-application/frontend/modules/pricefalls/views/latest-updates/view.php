...
$latestUpdates = LatestUpdateInfo::getLatestUpdates();
?>
		...
		<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
			<div class="new-section latest-update">
				    ...
				    <div class="jet-pages-heading">
				        ...
				        <p> Created At : <?= LatestUpdateInfo::getFormattedTime($model->created_at) ?></p>
				        <p> Updated At : <?= LatestUpdateInfo::getFormattedTime($model->updated_at) ?></p>
				    </div>
							...
							<div class="update-content">
								<ul class="update-list list-style">
									<?php if(count($latestUpdates)) : ?>
										...
										<?php 	$time = LatestUpdateInfo::timeDifference($latestUpdate['updated_at']);?>
										<li>
