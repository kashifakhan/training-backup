		        	 	...
		        	 	?>
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefallsproduct/index">Manage Products</a></li>
			        	 			...
			        	 			?>
										...
										<a href="#">Account</a>
											<ul class="dropdown-menus">
												...
												<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/how-to-sell-on-pricefalls-com">Documentation</a></li>
												<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/site/index?tour">Quick Tour</a></li>
												<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefalls-report/index">Reports</a></li>
												<li class="logout_merchant"><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/site/logout">Logout</a></li>
											</ul>
										</li>
									<?php
