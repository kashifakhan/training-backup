...
<head>
	...
	<script type="text/javascript" src="<?= Yii::$app->getUrlManager()->getBaseUrl();?>/js/jquery.js"></script>
	    <?= Html::csrfMetaTags() ?>
	     <title><?= Html::encode("Shopify pricefalls Integration | CedCommerce");?></title>
...
<body class="iframe-body">
	...
	?>
	<?php $this->beginBody() ?>
 	<div class="wrap ced-pricefalls-navigation-mbl">
				...
				<!-- Brand and toggle get grouped for better mobile display -->
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="<?= Yii::getAlias('@webbaseurl') ?>/site/index">Home</a></li>
							<li><a  href="<?= Yii::getAlias('@webbaseurl') ?>/site/about">About</a></li>
						<?php if (Yii::$app->user->isGuest) {
								?>
							<li><a href="<?= Yii::getAlias('@webbaseurl') ?>/site/contact-form">Contact Us</a></li>
							<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/default/index">Dashboard </a></li>
							<li><a href="<?= Yii::getAlias('@webbaseurl') ?>/site/login">Login</a></li>
		        	 	<?php }
		        	 	else{
		        	 	?>
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefalls-attributemap/index">Map pricefalls Attributes</a></li>
									<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefalls-products/index">Manage Products</a></li>
									<li role="separator"></li>
									<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefallsproduct-fileupload/index">Bulk Upload/Update</a></li>
									<li><a  href="<?=Yii::getAlias('@webpricefallsurl') ?>/pricefallsproductslist/index">Listing on pricefalls</a></li>
								</ul>
							</li>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefallscsvupdate/index">Product Archive/Unarchive</a></li>
                                    <li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefallsproduct-fileupload/csvupload">CSV Product Upload</a></li>
                                </ul>
                            </li>
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Orders<span class="caret"></span></a>
								<ul class="dropdown-menu">
									<li><a  href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefallsorderdetail/index">Sales Orders</a></li>
									<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefallsorderimporterror/index">Failed Orders</a></li>
									<li><a  href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefallsreturn/index">Return Orders</a></li>
									<li role="separator"></li>
									<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefallsrefund/index">Refund Orders</a></li>
								</ul>
							</li>
							<?php if (!Yii::$app->user->isGuest)
							{
					            ...
					            <li>
					                <a class="icon-items " href="javascript:void(0)" onclick="callView()">
					                    <img class="call-icon-img" src="<?= Yii::getAlias('@pricefallsbasepath'); ?>/assets/images/icons/call.png">
					                </a>
							...
							<li ><a class="icon-items" href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefallsconfiguration/index"><img src="<?= Yii::getAlias('@pricefallsbasepath'); ?>/assets/images/icons/setting.png"></a></li>

							<li class="dropdown ">
								<a href="#" class="dropdown-toggle icon-items" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="<?= Yii::getAlias('@pricefallsbasepath'); ?>/assets/images/icons/dropdown.png"></a>
								<ul class="dropdown-menu">
									...
									<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/how-to-sell-on-pricefalls-com">Documentation</a></li>
									<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/site/index?tour">Quick Tour</a></li>
									<?/*<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefallsreport/index">Reports</a></li>*/?>
			        	 			...
			        	 			?>
										<li class="dropdowns">
											...
											<ul class="dropdown-menus">
												...
												<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefalls-products/index">Manage Products</a></li>
												<li role="separator"></li>
												<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefallsdynamicprice/index">pricefalls Repricing</a></li>
												<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefallsproductslist/index">Listing on pricefalls</a></li>
											</ul>
										</li>
										<li class="dropdowns">
											...
											<ul class="dropdown-menus">
												<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/productcsv/index">Product update</a></li>
												<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefallscsvupdate/index">Product Archieve/Unarchieve</a></li>
												<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefallsproduct-fileupload/csvupload">CSV Product Upload</a></li>
											</ul>
										</li>
										...
										<li class="dropdowns">
											<a href="#">Order</a>
											<ul class="dropdown-menus">
												<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefallsorderdetail/index">Sales Order</a></li>
												<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefallsorderimporterror/index">Failed Order</a></li>
												<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefallsreturn/index">Return Order</a></li>
												<li role="separator"></li>
												<li><a href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefallsrefund/index">Refund Order</a></li>
											</ul>
										</li>
										...
										<li >
											<a class="icon-items" href="<?= Yii::getAlias('@webpricefallsurl') ?>/pricefallsconfiguration/index">setting</a>
										</li>
										<li class="dropdowns ">
										<a href="#">Account</a>
											<ul class="dropdown-menus">
...
<!--	    	--><?//= Alert::widget() ?>
	...
	?>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
	                    <div class="skype">
	                        ...
	                        if (!Yii::$app->user->isGuest) {
	                            $topic = Yii::$app->user->identity->owner_name;
	                        }
	                        ?>
		...
		<div class="copyright-section">
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<a title="Click Here to install shopify - pricefalls/walmart integration app (Android)" href="https://play.google.com/store/apps/details?id=com.cedcommerce.shopifyintegration&hl=en" target="_blank"><img src="<?= Yii::$app->request->baseUrl ?>/images/GooglePlay.png"></a>
					<a title="Click Here to install shopify - pricefalls/walmart integration app (IOS)" href="https://itunes.apple.com/us/app/cedbridge-for-shopify/id1186746708?ls=1&mt=8" target="_blank"><img src="<?= Yii::$app->request->baseUrl ?>/images/App-Store.png"></a>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="copyright">
